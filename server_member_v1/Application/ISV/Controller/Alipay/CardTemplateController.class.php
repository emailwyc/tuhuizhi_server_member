...
class CardTemplateController extends AlipayCommonController
{
    ...
    public function _initialize(){
        ...
        $this->aop->appId = $this->setting['appid'];//动态配置appid
        $this->aop->rsaPrivateKey = $this->setting['ras_path'];//动态配置私钥串存储路径
        $this->aop->alipayrsaPublicKey = $this->setting['pub_key'];//动态配置
        ...
        $this->appAuthToken = $this->getAppAuthToken($this->adminInfo['alipay_appid']);
    }
    ...
    public function getTemplateInfo() {
        ...
        $result = $this->aop->execute ( $request,null,$this->appAuthToken);
...
"HUABEI_FUWU"
        ...
        $result = $aop->execute ( $request,null,$this->appAuthToken);
     ...
     * @return mixed
     */
    public function createTemplateInfo() {
        $this->emptyCheck($this->params);
...
"template_style_info":{
    "card_show_name":"花呗联名会员卡",
    "logo_id":"NZkmirYQTXeLPIJr33uQkgAAACMAAQED",
    "color":"RGB(25,168,203)",
    "background_id":"zKfh7kqvS8yRmcDY2igTUwAAACMAAQED",
    "bg_color":"RGB(25,168,203)",
    "feature_descriptions":[
    "使用花呗卡可享受免费分期"
    ]
...
"column_info_list":[
    ...
    },
    {
        ...
        "more_info":{
            "title":"会员详情",
            "url":"https://render.alipay.com/p/f/hbcard/detail.html",
            "params":"{}",
            "descs":[]
        },
        "title":"会员详情",
...
"service_label_list":[
    ...
    public function logoUpload() {
        ...
        $request->setImageName("zhihuitutest");
        $request->setImageContent("@"."/home/soone/logo.jpg");
        $result = $this->aop->execute ( $request,null,$this->appAuthToken);
        $responseNode = str_replace(".", "_", $request->getApiMethodName()) . "_response";
        $resultCode = $result->$responseNode;
        echo "<pre>";
    ...
    public function cardUpload() {
        ...
        $request->setImageType("jpg");
        $request->setImageName("zhihuitutest");
        $request->setImageContent("@"."/home/soone/card.jpg");
        $result = $this->aop->execute ( $request,null,$this->appAuthToken);
        $responseNode = str_replace(".", "_", $request->getApiMethodName()) . "_response";
        $resultCode = $result->$responseNode;
        echo "<pre>";
