...
//        $pay_fee = 1; // 计算实际应付金额 单位分
    ...
    public function confirmPay()
    {
        ...
        writeOperationLog(array('停车缴费回调参数orderNo' => $orderNo), 'jaleel_logs');
...
//        $url = C('DOMAIN') . '/CrmService/OutputApi/Index/getuserinfobycard';
    ...
    public function getParkOrderLists()
    {
        ...
        $orders = $order->where(array('openid' => $this->user_openid, 'status' => 2))->order('createtime')->page($page, 10)->select();
