...
function QiniuJsSDK() {
    ...
    this.uploader = function(op) {
        ...
        plupload.extend(option, op, {
            url: location.protocol + '//up-z1.qbox.me',
            multipart_params: {
                token: ''
            }
        });
        ...
        uploader.bind('BeforeUpload', function(up, file) {
            ...
            if (uploader.runtime === 'html5' && chunk_size) {
                if (file.size < chunk_size) {
                    ...
                    up.setOption({
                        'url': location.protocol + '//up-z1.qbox.me/mkblk/' + blockSize,
                        'multipart': false,
        ...
        uploader.bind('ChunkUploaded', function(up, file, info) {
            ...
            if (leftSize < chunk_size) {
                up.setOption({
                    'url': location.protocol + '//up-z1.qbox.me/mkblk/' + leftSize
                });
            }
        ...
        uploader.bind('FileUploaded', (function(_FileUploaded_Handler) {
            return function(up, file, info) {
                ...
                if (ctx) {
                    ...
                    var url = location.protocol + '//up-z1.qbox.me/mkfile/' + file.size + key + x_vars_url;
                    var ajax = that.createAjax();
