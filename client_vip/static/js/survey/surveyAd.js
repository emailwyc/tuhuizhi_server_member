require('../../scss/survey/surveyAd.scss');
import { getAdsense, editAdsense } from '../model/survey';
...
const surveyAd = {
  ...
  getAdsense() {
    getAdsense({
      ...
      console.log(success);
      this.$title.val(success.data.title);
      this.$link.val(success.data.link);
      $('#image').attr('src', success.data.icon);
    }, error => {
      console.log(error);
    });
  },
