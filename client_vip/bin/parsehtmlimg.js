...
parseImg('./app/views/mall_campaign.html');
parseImg('./app/views/mall_gift.html');
parseImg('./app/views/mall.html');
parseImg('./app/views/member_card.html');
parseImg('./app/views/member_contact.html');
parseImg('./app/views/member_followcode.html');
parseImg('./app/views/member_rights.html');
parseImg('./app/views/user_admin.html');
parseImg('./app/views/user_login.html');
// parseImg('./app/views/parking_order.html');
// parseImg('./app/views/parking_discount.html');
