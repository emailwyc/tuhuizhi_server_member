...
class ThirdwechatcommonController extends ErrorcodeController{
    ...
    protected $token='rtmap_open_weixin';//第三方平台申请时填写的接收消息的校验token
    protected $encodingAesKey='2a2ba460c451ca4bc459ff6d9eae6a9dc451ca4bc45';//第三方平台申请时填写的接收消息的加解密symmetric_key
    protected $appId='wxcdf6eb2f473255d5';//公众号第三方平台的appid
    protected $appsecret='41c82e625a058471243d4b385765c7d8';//公众号第三方平台的appsecret
