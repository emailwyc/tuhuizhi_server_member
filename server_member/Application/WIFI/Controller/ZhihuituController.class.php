...
class ZhihuituController extends JaleelController
{
    protected static $appid = 'wxf3a057928b881466';
    ...
    {
        $obj = M('zhihuitu_default');
        $wifi_info = $obj->where(array('customer_name' => 'wifi'))->find();

        writeOperationLog(array('get wifi config ' => json_encode($wifi_info)), 'jaleel_logs');
    ...
    protected static function checkUser($openid) {
