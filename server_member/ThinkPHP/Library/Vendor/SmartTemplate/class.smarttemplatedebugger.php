	...
	class SmartTemplateDebugger
	{
		...
		*/
		function start ( $vars )
		{
			...
			// Print Index
			echo '<fonts face="Arial" Size="3"><b>';
			echo 'SmartTemplate Debugger<br>';
			echo '<fonts size="2"><li>PHP-Script: ' . $_SERVER['PATH_TRANSLATED'] . '</li><li>Template: ' . $this->filename . '</li></font><hr>';
			...
			// Print Template
			echo '<a name="template_code"><br><fonts face="Arial" Size="3"><b>Template:</b>&nbsp;[<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(\'Template\'), this); return false">Hide Ouptut</a>]</fonts><br>';
			...
			if (@include_once ("class.smarttemplateparser.php"))
			{
				...
				echo '<a name="compiled_code"><br><br><fonts face="Arial" Size="3"><b>Compiled Template:</b>&nbsp;[<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(\'Compiled\'), this); return false">Hide Ouptut</a>]</fonts><br>';
			...
			// Print Data
			echo '<a name="data_code"><br><br><fonts face="Arial" Size="3"><b>Data:</b>&nbsp;[<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(\'Data\'), this); return false">Hide Ouptut</a>]</fonts><br>';
		...
		*/
		function highlight_html ( $code )
		{
			...
			$code  =  preg_replace('/([a-zA-Z_]+)=/',  '<fonts color="#FF0000">$1=</fonts>',  $code);
			$code  =  preg_replace('/(&lt;[\/a-zA-Z0-9&;]+)/',  '<fonts color="#0000FF">$1</fonts>',  $code);
			$code  =  str_replace('&lt;!--',  '<font color="#008080">&lt;!--',  $code);
			$code  =  str_replace('--&gt;',  '--&gt;</fonts>',  $code);
			$code  =  preg_replace('/[\r\n]+/',  "\n",  $code);
			return $code;
		}
	}
