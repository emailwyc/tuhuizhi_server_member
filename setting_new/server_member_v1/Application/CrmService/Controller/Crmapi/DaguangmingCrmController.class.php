...
class DaguangmingCrmController extends CommonController implements CrminterfaceController
{
    //protected $md5_key = '201701150000'; // md5加密密钥
    //protected $uname = 'test';
    //protected $request_url = 'http://103.75.89.36:1880/CRM_VIP_Proxy.asmx?wsdl';
    protected $md5_key = '20180306'; // md5加密密钥
    protected $uname = 'zhtgzh';
    protected $request_url = 'http://111.33.1.181:1880/CRM_VIP_Proxy.asmx?wsdl';//新地址
    //切换正式环境还需要修改卡等级编码


/*
    public function GetUserinfoByCard1()
    {
        ...
        $result= $webservice->sopaCall('getbasicinfo', $client, $data);
        print_r($result);exit;
    }
*/
...
//                    $sv = $this->checkupdate($db, $sel, $rt);
                ...
                $datas['xf_vipcardno']=$rt['cardno'];//$array['GetVipInfoResult']['DATA']['VIP']['xf_vipcardno'];
                ...
                $datas['company']='';
                $datas['idnumber'] = $array['GetVipInfoResult']['DATA']['VIP']['xf_vipid'];
        ...
        if (in_array('',$params)){//获取的参数不完整
            ...
            if (is_object($result)){
                ...
                if (0 == $array['GetVipInfoByMobileOpenIDResult']['Header']['ERRCODE']){
                    ...
                    $rt['birthday']=$array['GetVipInfoByMobileOpenIDResult']['DATA']['VIP']['xf_birthdayyyyy'].'-'.$array['GetVipInfoByMobileOpenIDResult']['DATA']['VIP']['xf_birthdaymm'].'-'.$array['GetVipInfoByMobileOpenIDResult']['DATA']['VIP']['xf_birthdaydd'];
                    $rt['company']='';
                    ...
                    $datas['cardno']=$rt['cardno'];
                    $datas['xf_vipcardno']=$rt['cardno'];//$array['GetVipInfoByMobileOpenIDResult']['DATA']['VIP']['xf_vipcardno'];
                    $datas['user']=$rt['usermember'];
                    $datas['name']=$rt['usermember'];
                    ...
                    $datas['birthday']=date('Y-m-d',strtotime($rt['birthday']));
                    $datas['birth']=$datas['birthday'];
                    $datas['company']='';
                    $datas['phone']=$rt['phone'];
                    $datas['mobile']=$rt['phone'];
                    $datas['address']=$rt['address'];
                    $datas['idnumber'] = $array['GetVipInfoByMobileOpenIDResult']['DATA']['VIP']['xf_vipid'];
    ...
    public function createMember()
    {
        ...
        if (is_object($result)){
            ...
            if (0 == $array['VipCreateResult']['Header']['ERRCODE']){
                ...
                $d['xf_vipcardno']=$array['VipCreateResult']['DATA']['xf_vipcode'];
