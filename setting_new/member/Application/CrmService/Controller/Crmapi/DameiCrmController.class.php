...
class DameiCrmController extends CommonController implements CrminterfaceController
{
    ...
    protected $md5_key = '201701151322'; // md5加密密钥
    protected $uname = 'mallcoo';
    protected $request_url = 'http://111.204.109.53:2880/CRM_VIP_Proxy.asmx?wsdl';//新地址
    //切换正式环境还需要修改卡等级编码
