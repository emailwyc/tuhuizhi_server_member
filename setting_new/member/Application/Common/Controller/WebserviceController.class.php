...
class WebserviceController extends Controller
{
     ...
     * @param array $params
     */
    public function soapClient(string $url, $time = 5, $params = array())
    {
        $params['connection_timeout'] = $time;
        try{
...
//             returnjson(array('code'=>101, 'data'=>$exception), PublicService::returnstyle(), PublicService::callback());
        }
     ...
     * @param array $params 传递的参数
     */
    public function doRequest($params, $url, $funtion_name, $client)
    {
        $result = $client->__doRequest($params,$url,$funtion_name,1,0);//发送xml必须使用__doRequest
        $this->function_name=$funtion_name;
        $this->result=$result;
        $this->params=$params;
        $this->log();
        return $result;
